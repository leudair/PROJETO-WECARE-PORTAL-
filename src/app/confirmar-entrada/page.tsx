...
export default async function ConfirmarEntradaPage({
  searchParams,
}: {
    ...
    <main className="relative flex min-h-screen items-center justify-center bg-background px-4">
      ...
      <div className="w-full max-w-sm space-y-4 rounded-xl border border-border bg-surface p-8 shadow-sm">
        <div className="space-y-3">
          ...
          <div>
            <h1 className="text-xl font-semibold text-foreground">Entrar no WeCare Portal</h1>
            <p className="text-sm text-muted">Clique no botão abaixo para confirmar a entrada.</p>
          </div>
        </div>
