...
export default function EntrarComEmailPage() {
    ...
    <main className="relative flex min-h-screen items-center justify-center bg-background px-4">
      ...
      <div className="w-full max-w-sm space-y-4 rounded-xl border border-border bg-surface p-8 shadow-sm">
        <div className="space-y-3">
          ...
          <div>
            <h1 className="text-xl font-semibold text-foreground">Entrar só com e-mail</h1>
            <p className="text-sm text-muted">
              Informe seu email de login e enviaremos um link para você entrar sem precisar de senha.
            </p>
          </div>
        </div>
        ...
        {state?.sent ? (
          <p className="text-sm text-foreground">
            Se esse email tiver uma conta, enviamos um link de acesso para ele. Confira também a caixa de spam.
          </p>
        ) : (
