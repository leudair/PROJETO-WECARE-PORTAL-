        ...
        <div className="absolute z-10 mt-1 w-full space-y-1 rounded-md border border-border bg-surface p-1 shadow-lg max-h-64 overflow-y-auto">
          {employees.map((e) => (
            <button
              ...
              className="block w-full rounded-md border border-red-600 bg-red-600 px-3 py-2 text-left text-sm font-medium text-white hover:bg-red-700 dark:border-red-700 dark:bg-red-700 dark:hover:bg-red-600"
            >
              {e.full_name}
            </button>
          ))}
